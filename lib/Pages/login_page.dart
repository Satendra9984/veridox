...
class _LogInPageState extends State<LogInPage> {
    ...
    await FirebaseAuth.instance.verifyPhoneNumber(
        ...
        verificationCompleted: (PhoneAuthCredential credential) async {
          ...
          if (FirebaseAuth.instance.currentUser == null) {
            Navigator.pushReplacement(context, CupertinoPageRoute(builder: (context) => const AssignmentsHomePage()));
          }
        },
  ...
  void changeScreen() async {
    if (FirebaseAuth.instance.currentUser == null) {
      PhoneAuthCredential _credential = PhoneAuthProvider.credential(verificationId: id, smsCode: _pinputController.text);
